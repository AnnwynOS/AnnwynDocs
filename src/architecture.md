...
Annwyn is an experimental operating system architecture that explores alternatives to many of the abstractions inherited from Unix and modern desktop systems.
...
Annwyn is designed around modern hardware realities.
...
ClionadhUI provides the reactive layer built on top of ObjectUI.
...
Annwyn does not seek to modernize Unix.
